from pyniryo import NiryoRobot, PoseObject, JointsPosition, PoseMetadata
...
if __name__ == '__main__':
    ...
    # Move in frame
    robot.move(PoseObject(0, 0, 0.1, 0, 0, 0, metadata=PoseMetadata.v2("dynamic_frame")))
    robot.move(PoseObject(0.1, 0, 0, 0, 0, 0, metadata=PoseMetadata.v2("dynamic_frame")))
    robot.move(PoseObject(0, 0, -0.1, 0, 0, 0, metadata=PoseMetadata.v2("dynamic_frame")))
