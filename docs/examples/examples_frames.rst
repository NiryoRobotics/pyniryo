...
If you want to see more about dynamic frames functions, you can look at :py:meth:`dynamic frames functions<pyniryo.api.tcp_client.NiryoRobot.get_saved_dynamic_frame_list>`
