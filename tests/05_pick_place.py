...
class Test01PickAndPlace(BaseTestTcpApi):
    ...
    def test_050_place(self):
        self.assertIsNone(self.niryo_robot.place(self.pose_v1))
    ...
    def test_070_pick_and_place(self):
        for pose_a in [self.pose_list, self.pose_v1]:
            for pose_b in [self.pose_list, self.pose_v1]:
