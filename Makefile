...
gen_openapi:
	source venv/bin/activate && datamodel-codegen --input $(SPECS_DIR)/openapi.yml --output pyniryo/nate/_internal/transport_models/models_gen.py --output-model-type pydantic_v2.BaseModel --output-datetime-class datetime --input-file-type openapi
